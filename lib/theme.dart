...
TextTheme _lightTextTheme() => TextTheme(
      displayLarge: _satoshi(FontSizes.displayLarge,
          weight: FontWeight.w400, color: LightModeColors.onSurface),
      displayMedium: _satoshi(FontSizes.displayMedium,
          weight: FontWeight.w400, color: LightModeColors.onSurface),
      displaySmall: _satoshi(FontSizes.displaySmall,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      headlineLarge: _satoshi(FontSizes.headlineLarge,
          weight: FontWeight.w500, color: LightModeColors.onSurface),
      headlineMedium: _satoshi(FontSizes.headlineMedium,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      headlineSmall: _satoshi(FontSizes.headlineSmall,
          weight: FontWeight.w700, color: LightModeColors.onSurface),
      titleLarge: _satoshi(FontSizes.titleLarge,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      titleMedium: _satoshi(FontSizes.titleMedium,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      titleSmall: _satoshi(FontSizes.titleSmall,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      labelLarge: _satoshi(FontSizes.labelLarge,
          weight: FontWeight.w700, color: LightModeColors.onSurface),
      labelMedium: _satoshi(FontSizes.labelMedium,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      labelSmall: _satoshi(FontSizes.labelSmall,
          weight: FontWeight.w600, color: LightModeColors.onSurface),
      bodyLarge: _satoshi(FontSizes.bodyLarge,
          weight: FontWeight.w400, color: LightModeColors.onSurface),
      bodyMedium: _satoshi(FontSizes.bodyMedium,
          weight: FontWeight.w400, color: LightModeColors.onSurface),
      bodySmall: _satoshi(FontSizes.bodySmall,
          weight: FontWeight.w400, color: LightModeColors.onSurface),
    );
...
TextTheme _darkTextTheme() => TextTheme(
      displayLarge: _satoshi(FontSizes.displayLarge,
          weight: FontWeight.w400, color: DarkModeColors.onSurface),
      displayMedium: _satoshi(FontSizes.displayMedium,
          weight: FontWeight.w400, color: DarkModeColors.onSurface),
      displaySmall: _satoshi(FontSizes.displaySmall,
          weight: FontWeight.w600, color: DarkModeColors.onSurface),
      headlineLarge: _satoshi(FontSizes.headlineLarge,
          weight: FontWeight.w500, color: DarkModeColors.onSurface),
      headlineMedium: _satoshi(FontSizes.headlineMedium,
          weight: FontWeight.w600, color: DarkModeColors.onSurface),
      headlineSmall: _satoshi(FontSizes.headlineSmall,
          weight: FontWeight.w700, color: DarkModeColors.onSurface),
      titleLarge: _satoshi(FontSizes.titleLarge,
          weight: FontWeight.w600, color: DarkModeColors.onSurface),
      titleMedium: _satoshi(FontSizes.titleMedium,
          weight: FontWeight.w600, color: DarkModeColors.onSurface),
...
ThemeData get lightTheme => ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        filled: true,
        hintStyle: _satoshi(FontSizes.bodyMedium,
            color: LightModeColors.onSurface.withValues(alpha: 0.7)),
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              color: LightModeColors.primary.withValues(alpha: 0.6),
              width: 1.4),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide:
              BorderSide(color: const Color(0x22000000).withValues(alpha: 0.2)),
        ),
      ),
      ...
      filledButtonTheme: FilledButtonThemeData(
        style: ButtonStyle(
          ...
          foregroundColor:
              const WidgetStatePropertyAll(LightModeColors.onPrimary),
          backgroundColor:
              const WidgetStatePropertyAll(LightModeColors.primary),
        ),
      ),
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: ButtonStyle(
          ...
          side: WidgetStateProperty.resolveWith(
            (states) => BorderSide(
                color: LightModeColors.outline.withValues(
                    alpha: states.contains(WidgetState.disabled) ? 0.3 : 0.6)),
          ),
          foregroundColor:
              const WidgetStatePropertyAll(LightModeColors.onSurface),
          textStyle: WidgetStatePropertyAll(
            _satoshi(FontSizes.labelLarge, weight: FontWeight.w700),
          ),
        ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: ButtonStyle(
          foregroundColor:
              const WidgetStatePropertyAll(LightModeColors.primary),
          textStyle: WidgetStatePropertyAll(
              _satoshi(FontSizes.labelMedium, weight: FontWeight.w600)),
        ),
      ),
      ...
      // Global ElevatedButton styling to achieve a world-class, cohesive look
        ...
        style: ButtonStyle(
          ...
          backgroundColor: MaterialStateProperty.resolveWith<Color>((states) {
            if (states.contains(MaterialState.disabled))
              return LightModeColors.surfaceDim;
            // Primary color for light theme
            return LightModeColors.primary;
          }),
          foregroundColor:
              MaterialStateProperty.all<Color>(LightModeColors.onPrimary),
...
ThemeData get darkTheme => ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        filled: true,
        hintStyle: _satoshi(FontSizes.bodyMedium,
            color: DarkModeColors.onSurface.withValues(alpha: 0.7)),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide(
              color: DarkModeColors.primary.withValues(alpha: 0.6), width: 1.4),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide(
              color: const Color(0x22FFFFFF).withValues(alpha: 0.25)),
        ),
      ),
      cardTheme: CardThemeData(
      ...
      filledButtonTheme: FilledButtonThemeData(
        style: ButtonStyle(
          ...
          foregroundColor:
              const WidgetStatePropertyAll(DarkModeColors.onPrimary),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: ButtonStyle(
          ...
          side: WidgetStateProperty.resolveWith(
            (states) => BorderSide(
                color: DarkModeColors.outline.withValues(
                    alpha:
                        states.contains(WidgetState.disabled) ? 0.28 : 0.55)),
          ),
          foregroundColor:
              const WidgetStatePropertyAll(DarkModeColors.onSurface),
          textStyle: WidgetStatePropertyAll(
            _satoshi(FontSizes.labelLarge, weight: FontWeight.w700),
          ),
        ),
      ...
      // Global ElevatedButton styling for dark mode to ensure parity with light mode
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ButtonStyle(
          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
            RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
          ...
          backgroundColor: MaterialStateProperty.resolveWith<Color>((states) {
            if (states.contains(MaterialState.disabled))
              return DarkModeColors.surfaceDim;
            // Primary color for dark theme
            return DarkModeColors.primary;
          }),
          foregroundColor:
              MaterialStateProperty.all<Color>(DarkModeColors.onPrimary),
          textStyle: MaterialStateProperty.all<TextStyle>(
            _satoshi(FontSizes.labelLarge, weight: FontWeight.w700),
          ),
        ),
